$(document).ready(function(){
    //BEGINNING OF ADD SEMESTER//
   $("#addsemester").off().on("click",  function(e){
         e.preventDefault();
         ...
         if ($("#id_heads").val() == "") {          
            ...
            success: function(response) {
                ...
                var row = '<tr id="ROW-' + response.id + '"><td>' + response.heads + '</td> <td><a href=/semester/edit/' + response.id + '><img src="/static/img/edit.png"> </img></a></td><td><a href="#" class="remove" data-id=' + response.id + ' data-url="/semester/delete/'  + response.id + '/"> <img src="/static/img/delete.png"> </img> </a></td></tr>';                       
   ...
   //BEGINNING OF EDIT SEMISTER //

   $("#editsemester").off().on("click",  function(e){
         e.preventDefault();
